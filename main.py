...
question2_2.put()
question2_3 = Question(sequence = "2", question = "Find the address of Germany's oldest zoo.", answer = "Hardenbergplatz 8, 10787 Berlin, Germany", level_number = 3, hint = "Google it!", second_hint = "Have you Googled it yet?")
question2_3.put()
